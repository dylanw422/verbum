    ...
    <div className="w-full max-w-md mx-auto bg-zinc-900/40 backdrop-blur-md border border-zinc-800 rounded-sm p-8 relative overflow-hidden group">
      ...
      <div className="flex items-center gap-4 mb-8 border-b border-rose-500/20 pb-4">
        ...
        <div className="flex flex-col">
          <h1 className="text-lg font-mono tracking-[0.2em] text-zinc-100 uppercase">Registration</h1>
            ...
            {(field) => (
              <div className="space-y-2">
                ...
                <div className="relative group/input">
                  <User className="absolute left-3 top-2.5 h-4 w-4 text-zinc-600 group-focus-within/input:text-rose-500 transition-colors" />
                  <Input
                    id={field.name}
                    name={field.name}
